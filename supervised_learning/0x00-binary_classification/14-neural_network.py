...
class NeuralNetwork:
    ...
    def gradient_descent(self, X, Y, A1, A2, alpha=0.05):
        ...
        and updates the private attributes __W1, __b1, __W2, and __b2
        ...
        - Y (numpy.ndarray) with shape (1, m) that contains the correct
            labels for the input data
        - A1 (numpy.ndarray) with shape (1, m) containing the activated
    ...
    def train(self, X, Y, iterations=5000, alpha=0.05):
        ...
        - iterations is the number of iterations to train over
            - if it is not an integer, raise a TypeError with the
            exception iterations must be an integer
            - if it is not positive, raise a ValueError with the
